...
(function () {
    ...
    function patio() {
        ...
        function remover(placa) {
            ...
            var tempo = calTempo(new Date().getTime() - new Date(entrada).getTime());
            if (!confirm("O veiculo ".concat(nome, " premaneceu por ").concat(tempo, ".Deseja encerrar?")))
                return;
    ...
    (_a = $("#cadastrar")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function () {
        ...
        if (!nome || !placa) {
            alert("Os campos nome e placa são obregatorio");
            return;
        }
